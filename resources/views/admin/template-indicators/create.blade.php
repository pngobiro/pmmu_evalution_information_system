            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        {{ __('Create New Master Indicator') }}
                        <a href="{{ route('unit-ranks.fy.indicator-groups.indicators.index',[$rank_id,$fy_id,$group_id]) }}" class="float-right">Back</a>
                    </div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('unit-ranks.fy.indicator-groups.indicators.store',[$rank_id,$fy_id,$group_id]) }}">
                            @csrf
