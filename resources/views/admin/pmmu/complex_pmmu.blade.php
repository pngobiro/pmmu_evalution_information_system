                    ...
                    <table class="table table-bordered table table-sm text-dark" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><b>{{ round($indicator->indicator_performance_score,2) }}</b> </td>
                                <td>{{ round($indicator->indicator_raw_score,2) }}</td> 
                                <td><b>{{ round($indicator->indicator_weighted_score,2) }}</b> </td>
