...
} elseif ($_instance->childHasBeenRendered('WTMJE7x')) {
    $componentId = $_instance->getRenderedChildComponentId('WTMJE7x');
    $componentTag = $_instance->getRenderedChildComponentTagName('WTMJE7x');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WTMJE7x');
} else {
    $response = \Livewire\Livewire::mount('offline', []);
    $html = $response->html();
    $_instance->logRenderedChild('WTMJE7x', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('79cE6XU')) {
    $componentId = $_instance->getRenderedChildComponentId('79cE6XU');
    $componentTag = $_instance->getRenderedChildComponentTagName('79cE6XU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('79cE6XU');
} else {
    $response = \Livewire\Livewire::mount('indicator-form', ['indicatorId' => $indicator->id,'indicator_id' => $indicator->id]);
    $html = $response->html();
    $_instance->logRenderedChild('79cE6XU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>  </td>
                    </tr>
