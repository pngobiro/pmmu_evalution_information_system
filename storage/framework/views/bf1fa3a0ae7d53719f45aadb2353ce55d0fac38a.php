                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('users.update', $user->id)); ?>">
                            ...
                            <div class="form-group row">
                                <label for="pj_number"
                                    class="col-md-4 col-form-label text-md-right"><?php echo e(__('PJ Number')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="pj_number"
                                        value="<?php echo e(old('pj_number', $user->pj_number)); ?>" required autocomplete="pj_number"
                                        autofocus>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="m-2 p-2">
                    <form method="POST" action="<?php echo e(route('users.destroy', $user->id)); ?>">
                        ...
                        <button class="btn btn-danger">Delete <?php echo e($user->pj_number); ?></button>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ngobiro/lampstack-8.1.1-0/frameworks/laravel/resources/views/admin/users/edit.blade.php ENDPATH**/ ?>