...
} elseif ($_instance->childHasBeenRendered('lHBF4eE')) {
    $componentId = $_instance->getRenderedChildComponentId('lHBF4eE');
    $componentTag = $_instance->getRenderedChildComponentTagName('lHBF4eE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('lHBF4eE');
} else {
    $response = \Livewire\Livewire::mount('indicator-weight-form', ['indicatorId' => $indicator->id,'indicator_id' => $indicator->id]);
    $html = $response->html();
    $_instance->logRenderedChild('lHBF4eE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>  </td>
...
} elseif ($_instance->childHasBeenRendered('VVO1coK')) {
    $componentId = $_instance->getRenderedChildComponentId('VVO1coK');
    $componentTag = $_instance->getRenderedChildComponentTagName('VVO1coK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VVO1coK');
} else {
    $response = \Livewire\Livewire::mount('indicator-target-form', ['indicatorId' => $indicator->id,'indicator_id' => $indicator->id]);
    $html = $response->html();
    $_instance->logRenderedChild('VVO1coK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>  
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ngobiro/lampstack-8.1.1-0/frameworks/laravel/resources/views/admin/indicators/update_targets.blade.php ENDPATH**/ ?>