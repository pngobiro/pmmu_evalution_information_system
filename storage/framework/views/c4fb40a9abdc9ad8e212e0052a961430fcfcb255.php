    ...
    <div class="jumbotron">
        ...
        <p class="lead"> <span class="badge badge-primary">Financial Year</span> <?php echo e($fy->name); ?> </p>
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <form method="GET" action="<?php echo e(route('unit-ranks.fy.show',[$unit_rank->id,$fy->id ])); ?>">
                            <div class="form-row align-items-center">
                             
                                <div class="col">
                                    <a href="<?php echo e(route('unit-ranks.fy.rank_category.template-groups.index', [$unit_rank->id,$fy->id,$rank_category->id])); ?>" class="btn btn-success"><i class="fa fa-eye" aria-hidden="true"></i>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ngobiro/lampstack-8.1.2-0/frameworks/laravel/resources/views/admin/template_indicator_groups/index.blade.php ENDPATH**/ ?>