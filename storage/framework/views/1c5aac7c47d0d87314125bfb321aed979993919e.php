        ...
        <p class="lead"><span class="badge badge-primary">Group</span><?php echo e($template_group->name); ?></p>
                ...
                <div class="card">
                    <div class="card-header">
                        <?php echo e(__('Create New Template Indicator')); ?>

                        <a href="<?php echo e(route('unit-ranks.fy.template-groups.template-indicators.index',[$unit_rank->id,$fy->id,$template_group->id])); ?>" class="float-right"><i class="fa fa-arrow-left" aria-hidden="true"></i> Go Back</a>
                    </div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('unit-ranks.fy.template-groups.template-indicators.store',[$unit_rank->id,$fy->id,$template_group->id])); ?>">
                            ...
                            <div class="form-group row">
                                <label for="master_indicator_id" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Master Indicator')); ?></label>

                                <div class="col-md-6">
                                    <select id="master_indicator_id" class="form-control <?php $__errorArgs = ['master_indicator_id'];
...
unset($__errorArgs, $__bag); ?>" name="master_indicator_id" required>
...
unset($__errorArgs, $__bag); ?>"
                                        name="indicator_weight" value="<?php echo e(old('indicator_weight')); ?>" required autocomplete="indicator_weight">
...
unset($__errorArgs, $__bag); ?>"
                                        name="order" value="<?php echo e(old('order')); ?>" required autocomplete="order">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit" class="btn btn-primary"> <i class="fa fa-plus" aria-hidden="true"></i><?php echo e(__('Create New Template')); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ngobiro/lampstack-8.1.1-0/frameworks/laravel/resources/views/admin/template-indicators/create.blade.php ENDPATH**/ ?>